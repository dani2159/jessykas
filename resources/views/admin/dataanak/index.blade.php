                            ...
                            <div class="card-header">
                                <button class="float-right btn btn-primary btn-sm" data-toggle="modal"
                                    data-target="#addModal" data-backdrop="static" data-keyboard="false"><span
                                        class="fa fa-plus"></span> Tambah Data Anak</button>
                            </div>
                            <div class="card-body">
                                                ...
                                                <td>
                                                    @if ($item->kms == 0)
                                                        <i class="fas fa-check-circle fa-lg" aria-hidden="true"
                                                            style="color: green"></i>
                                                    @else
                                                        <i class="fas fa-times-circle fa-lg" aria-hidden="true"
                                                            style="color: red"></i>
                                                    @endif
                                                </td>
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <a href="{{ route('admin.dataanak.detailanak', $item->id_anak) }}"
                                                            class="btn btn-success btn-sm"><span
                                                                class="fa fa-id-card"></span></a>
                                                        <button class="btn btn-danger btn-sm"
                                                            onclick="hapusData({{ $item->id_anak }})"><span
                        ...
                        <div class="form-group ">
                            ...
                            <div class="input-group">
                                ...
                                <select name="dataibu" id="dataibu" required class="form-control select2bs4">
                                    ...
                                    @foreach ($Ibu as $item)
                                        <option value="{{ $item->id_ibu }}">{{ $item->nama_ibu }} -
                                            {{ $item->nama_suami }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="tmp_lahir" name="tempat_lahir"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="berat_badan" name="berat_badan"
                                            required placeholder="Berat Badan">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="tinggi_badan" name="tinggi_badan"
                                            required placeholder="Tinggi Badan">
                                        <div class="input-group-append">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" readonly class="form-control" id="nikupdate" name="nik"
                        ...
                        <div class="form-group ">
                            ...
                            <div class="input-group">
                                ...
                                <select name="dataibu" id="dataibuupdate" required class="form-control select2bs4">
                                    <option value="">-- Pilih Data Orangtua --</option>
                                    @foreach ($Ibu as $item)
                                        <option value="{{ $item->id_ibu }}">{{ $item->nama_ibu }} - {{ $item->nik }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="tmp_lahirupdate"
                                            name="tempat_lahir" required placeholder="Masukkan tempat lahir">
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" class="form-control" id="tgl_lahirupdate"
                                            name="tanggal_lahir" required placeholder="Masukkan tanggal lahir">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="berat_badanupdate"
                                            name="berat_badan" required placeholder="Berat Badan">
                                        <div class="input-group-append">
                                            <div class="input-group-text">Kg</div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="tinggi_badanupdate"
                                            name="tinggi_badan" required placeholder="Tinggi Badan">
                                        <div class="input-group-append">
                                            <div class="input-group-text">cm</div>
                                        </div>
                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="anak_keupdate" name="anak_ke" required
                                    placeholder="Anak Ke" min="1">
                            </div>
                        </div>
                    </div>
