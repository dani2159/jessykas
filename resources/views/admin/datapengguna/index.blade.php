@extends('admin.layout.index', ['title' => 'Data Pengguna'])
                            ...
                            <div class="card-header">
                                <button class="float-right btn btn-primary btn-sm" data-toggle="modal"
                                    data-target="#addModal" data-backdrop="static" data-keyboard="false"><span
                                        class="fa fa-plus"></span> Tambah Data Pengguna</button>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama" required
                                placeholder="Masukkan Nama Lengka">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="role"><span class="text-danger">*</span> Peran</label>
            ...
            <form action="javascript:void(0)" id="formUpdate" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="nama"><span class="text-danger">*</span> Nama Lengkap</label>
                            <input type="text" class="form-control" id="namau" name="nama" required
                                placeholder="Masukkan Nama Lengka">
                        </div>
                        <div class="form-group">
                            <label for="username"><span class="text-danger">*</span> username</label>
                            <input type="text" class="form-control" id="usernameu" name="username" required
                                placeholder="Masukkan username">
                        </div>
                        <div class="form-group">
                            <label for="password"> Password</label>
                            <input type="password" class="form-control" id="passwordu" name="password"
                                placeholder="Masukkan Password">
                        </div>
                        <div class="form-group">
                            <label for="role"><span class="text-danger">*</span> Peran</label>
                            <select name="role" id="roleu" class="form-control" required>
                                <option value="">-- Pilih Peran --</option>
                                <option value="admin">Admin</option>
                                <option value="owner">Owner</option>
                            </select>
                        ...
                        <div class="form-group">
                            <label for="status"><span class="text-danger">*</span> Status</label>
                            <select name="status" id="statusu" class="form-control" required>
                                <option value="">-- Pilih Status --</option>
                                <option value="1">Aktif</option>
                                <option value="0">Tidak Aktif</option>
                            </select>
...
@section('js')
    ...
    <script>
        ...
        function ubahData(item) {
            $('#id').val(item.id);
            $('#namau').val(item.nama);
            $('#usernameu').val(item.username);
            $('#roleu').val(item.role).trigger('change');
            $('#statusu').val(item.status).trigger('change');
            $('#updateModal').modal({
                backdrop: 'static',
                keyboard: false
            });
