@extends('admin.layout.index', ['title' => 'Data Pendapatan'])
                            ...
                            <div class="card-header">
                                <button class="float-right btn btn-primary btn-sm" data-toggle="modal"
                                    data-target="#addModal" data-backdrop="static" data-keyboard="false"><span
                                        class="fa fa-plus"></span> Tambah Data Pendapatan</button>
                            </div>
                            <div class="card-body">
            ...
            <form action="javascript:void(0)" id="formInsert" method="POST">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addModalLabel">Tambah Data Pendapatan</h5>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="kode_pendapatan"><span class="text-danger">*</span> Kode Pendapatan</label>
                            <input type="text" class="form-control" id="kode_pendapatan" name="kode_pendapatan" required
                                placeholder="Masukkan Kode Pendapatan">
                        </div>
                        <div class="form-group">
                            <label for="nama_pendapatan"><span class="text-danger">*</span> Nama Pendapatan</label>
    ...
    <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form action="javascript:void(0)" id="formUpdate" method="POST">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="updateModalLabel">Ubah Data Pendapatan</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="kode_pendapatanu"><span class="text-danger">*</span> Kode Pendapatan</label>
                            <input type="text" class="form-control" id="kode_pendapatanu" name="kode_pendapatan"
                                required placeholder="Masukkan Kode Pendapatan">
                        </div>
                        <div class="form-group">
                            <label for="nama_pendapatanu"><span class="text-danger">*</span> Nama Pendapatan</label>
                            <input type="text" class="form-control" id="nama_pendapatanu" name="nama_pendapatan"
                                required placeholder="Masukkan Nama Pendapatan">
                        </div>
                        <div class="form-group">
...
@section('js')
    ...
    <script>
        ...
        function ubahData(item) {
            $('#id').val(item.id);
            $('#nama_pendapatanu').val(item.nama_pendapatan);
            $('#kode_pendapatanu').val(item.kode_pendapatan);
