...
<body>
    ...
    <h2 style="border: 1.5px solid #000; text-align:center;">Bukti Penerimaan KAS</h2>
    <br>
    ...
    <b>
        <div>
            <table align="center">
                <tr>
                    <td style="width:30%">Penerimaan Untuk</td>
                    <td>:</td>
                ...
                <tr>
                    <td>Nominal</td>
                    <td>:</td>
                    <td style="border: 1.5px solid #000;">Rp. {{ number_format($transaksi->penerimaan, 0, ',', '.') }}
                </tr>
                <tr>
                    <td>Keterangan</td>
                    <td>:</td>
