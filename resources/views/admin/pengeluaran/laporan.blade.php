@extends('admin.layout.index', ['title' => 'Laporan Pengeluaran KAS'])
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Laporan Pengeluaran KAS</h1>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Laporan Pengeluaran KAS</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
    ...
    <script>
        $(function() {
            ...
            var table = $('#tabledata').DataTable({
                ...
                ajax: {
                    url: "{{ route('laporan.pengeluaran.list') }}",
                    type: 'GET',
                    dataType: 'json',
                    data: function(d) {
